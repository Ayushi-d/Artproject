...
public class Verticalhomeadapter extends RecyclerView.Adapter<Verticalhomeadapter.RecyclerViewHolder> {

    private ArrayList<Verticallistmodel> DataArrayList;
    private Context mcontext;

    public Verticalhomeadapter(ArrayList<Verticallistmodel> DataArrayList, Context mcontext) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        ...
        Verticallistmodel recyclerData = DataArrayList.get(position);
